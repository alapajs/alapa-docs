---
sidebar_position: 5
title: Controller-Based Routing
---
...
| ----------- | -------------- | --------------- |
| GET         | /users         | users.get.index |
| GET         | /users/:userId | users.get.user  |
...
| HTTP Method | Route Path     | Route Name          |
| ----------- | -------------- | ------------------- |
| GET         | /users         | app-users.get.index |
| GET         | /users/:userId | app-users.get.user  |
...
| GET         | /users/:userId | api/v1/users/\{userId\} |
...
class UserController extends Controller {
  ...
  useUser(req: Request, res: Response, next: NextFunction) {
    console.log("Middleware for /users/:userId");
    next();
  }
}
```
...
class PostController extends Controller {
  // Handles GET /posts/:postId/:userId
...
class PostController extends Controller {
  // Handles GET /posts/:postId/user/:userId
...
class PostController extends Controller {
  ...
  @Params("postId/draft")
  getIndex_(req: Request, res: Response) {
